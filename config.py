...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001959922658"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002453024937"))
...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://spideyofficial777:6FwYFNcgrAPL8nqq@spidey777.pykfj.mongodb.net/?retryWrites=true&w=majority&appName=SPIDEY777")
#your database name
DB_NAME = os.environ.get("DB_NAME", "SPIDEY777")

#for creating telegram thread for bot to improve performance of the bot
TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "60"))
#your start default command message.
START_MSG = os.environ.get("START_MESSAGE", "<b>Hᴇʟʟᴏ {first}\n\nI ᴄᴀɴ ꜱᴛᴏʀᴇ ᴘʀɪᴠᴀᴛᴇ ғɪʟᴇꜱ ɪɴ Sᴘᴇᴄɪғɪᴇᴅ Cʜᴀɴɴᴇʟ ᴀɴᴅ ᴏᴛʜᴇʀ ᴜꜱᴇʀꜱ ᴄᴀɴ ᴀᴄᴄᴇꜱꜱ ɪᴛ ғʀᴏᴍ ꜱᴘᴇᴄɪᴀʟ ʟɪɴᴋ.</b>")
...
SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "09c3f9bc3a8b121b1e6b82a954e59da523dd188e")
...
#images changes as per the your needed 
...
#UPI ID
UPI_ID = os.environ.get("UPI_ID", "xyz@fam")
#UPI QR CODE IMAGE
...
FORCE_MSG = os.environ.get("FORCE_MSG", "<b>Hᴇʟʟᴏ {first}\\nYᴏᴜ ɴᴇᴇᴅ ᴛᴏ ɪᴏɪɴ ɪɴ ᴍʏ Cʜᴀɴɴᴇʟ/Gʀᴏᴜᴘ ᴛᴏ ᴜꜱᴇ ᴍᴇ\ɴ\ɴKɪɴᴅʟʏ Pʟᴇᴀꜱᴇ ɪᴏɪɴ Cʜᴀɴɴᴇʟ....</b>")
#custom caption 
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>Tʀʏ ᴏᴜʀ ᴍᴏᴠɪᴇ ʙᴏᴛ <a href='https://telegram.me/Hacker_x_official_777'>ʜᴀᴄᴋᴇʀ_x_ᴏꜰꜰɪᴄɪᴀʟ_777</a></b>")
...
ADMIN_LIST = os.environ.get("ADMINS", "7965267063").split()
